...
const Become = () => {
    return (
        <div className='bg-white pt-[47px] pb-12 max-lg:py-[60px]'>
            <div className='max-w-[1240px] mx-auto px-6'>
                <div className='flex flex-wrap justify-between items-center'>
                    <div className='w-full lg:w-6/12'>
                        <div className='max-lg:text-center'>
                            <h2 className='font-abril font-semibold text-[39px] leading-[45px] text-dark-blue pb-5 max-sm:pb-[14px] max-w-[401px] max-md:text-[28px] max-md:leading-[34px]  max-lg:max-w-none'>Become an 8 figure seller with AI funding</h2>
