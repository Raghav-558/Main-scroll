...
const AccordionItem = ({ handleToggle, active, faq }) => {
    ...
    return (
        <div className="overflow-hidden border-b border-custom-light-gray">
            <div className="py-5 px-4">
                <div role="button" aria-expanded={active === id} aria-controls={`content-${id}`}
                    ...
                    <p className="font-poppins font-medium text-[18px] leading-6 text-dark-blue max-sm:max-w-[235px]">{title}</p>
        ...
        <div className="overflow-hidden bg-cream pt-[70px] pb-[60px] max-lg:pt-[60px]" >
            <div className='max-w-[1240px] mx-auto px-6'>
                <div className='text-center pb-[84px] max-lg:pb-10'>
                    ...
                    <h2 className='font-abril font-bold text-[39px] max-md:text-4xl max-md:leading-[36px] leading-[45px] max-sm:text-[28px] text-dark-blue pt-5 max-md:pt-[14px]'>Learn more with FAQ</h2>
                </div>
                <div className="">
