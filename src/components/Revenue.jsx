                ...
                <div className='flex flex-wrap -mx-3 justify-between max-md:flex-col-reverse'>
                    ...
                    <div className='max-md:w-full max-lg:w-1/2 w-5/12 px-3'>
                        <div className='max-md:text-center'>
                            <div className='w-9 h-9 rounded-full bg-[#0E1122] flex justify-center text-[28px] text-white max-md:mx-auto font-abril'>1</div>
                            <p className='font-semibold text-[39px] max-lg:text-4xl max-md:text-[28px] max-md:leading-9 leading-[45px] text-[#0E1122] md:max-w-[358px] pt-[19px] pb-1 max-md:py-[14px] font-abril'>Get an AI evaluation of your supply chain needs</p>
